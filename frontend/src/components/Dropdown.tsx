...
export function DropdownItem({
  ...
  let classes = clsx(
    ...
    // Focus
    // "data-[focus]:bg-green-500  data-[focus]:text-white",
    "data-[focus]:bg-zinc-950/5 data-[slot=icon]:*:data-[focus]:fill-zinc-950 text-zinc-950",
    "dark:text-white dark:data-[focus]:bg-white/5 dark:data-[slot=icon]:*:data-[focus]:fill-white",
